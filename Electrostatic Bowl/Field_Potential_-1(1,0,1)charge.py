...
for i in range(len(x_grid)):
    for j in range(len(z_grid)):
        ...
        phi[i,j] = myfns.potential(x0, y0, z0, Q, 8.854e-12) + q/(4*np.pi*8.854e-12 * np.sqrt((x0-1)**2 + (z0 - 1)**2))
